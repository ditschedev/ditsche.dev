const ExternalLink = ({ href, children }) => (
  <a
    className="text-gray-400 dark:text-gray-600 hover:text-primary-500 dark:hover:text-primary-300 transition"
    target="_blank"
    ...
    <footer>
      <div className="max-w-3xl mx-auto py-12 md:flex md:items-center md:justify-between">
        <div className="flex justify-center space-x-6 md:order-2">
          <ExternalLink href="//instagram.com">
          ...
          <ExternalLink href="https://twitter.com/ditschedev">
          ...
          <ExternalLink href="https://github.com/ditschedev">
          ...
          <ExternalLink href="https://dribbble.com/ditsche">
